CHESS = chess
GCC = gcc
OBJS = chess.o game.o tournament.o player.o chessSystemTestsExamplemaarouf.o
COMP_FLAG = -std=c99 -Wall -pedantic -errors -Werror 
DEBUG_FLAG =  -g
 
$(CHESS) :$(OBJS)
	$(GCC) $(DEBUG_FLAG) $(OBJS)  -o $@ -L. -lmap
chessSystemTestsExamplemaarouf.o : tests/chessSystemTestsExamplemaarouf.c chessSystem.h map.h test_utilities.h
